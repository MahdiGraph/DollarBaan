...
- **پایگاه داده**: 
  - **SQLite**: به صورت پیش‌فرض (بدون نیاز به نصب اضافی)
  - **MySQL/MariaDB** (اختیاری): در صورت تمایل به استفاده
- **API Key نوسان**: برای دریافت از [Navasan.tech](https://navasan.tech) ثبت‌نام کنید (دارای پلن رایگان)
...
# یا استفاده از PM2 در محیط تولید
npm install -g pm2
...
برای مدیریت برنامه در محیط تولید، از دستورات PM2 استفاده کنید:
