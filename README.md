...
- الزامی **کلید وب سرویس نوسان**: برای دریافت از [Navasan.tech](https://navasan.tech) ثبت‌نام کنید (دارای پلن رایگان)
- اختیاری **پایگاه داده**:
  - پیشفرض **SQLite**: به صورت پیش‌فرض (بدون نیاز به نصب اضافی)
